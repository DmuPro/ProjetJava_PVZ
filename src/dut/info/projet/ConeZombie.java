...
public class ConeZombie extends BasicZombie{
	private final String name ="ConeZombie";
	...
	private int item =36;
		...
		public ConeZombie(Coordinates coordonnee) {
			super(coordonnee);
		...
		public String toString() {
			return "ConeZombie [name=" + name + ", coordonnee=" + coordonnee + "]";
		}
