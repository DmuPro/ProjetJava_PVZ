...
public class DoomShroom implements InterfacePlant {
	private int pv;
	...
	public DoomShroom(Coordinates coordonnee) {
	...
	public String toString() {
		return "DoomShroom [name=" + name + ", coordonnee=" + coordonnee + "]";
	}
