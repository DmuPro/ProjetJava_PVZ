...
public class NewsPaperZombie extends ConeZombie{
	...
	private int item =14;
		...
		public NewsPaperZombie(Coordinates coordonnee) {
			super(coordonnee);
		...
		public String toString() {
			return "NewsPaperZombie [name=" + name + ", coordonnee=" + coordonnee + "]";
		}
