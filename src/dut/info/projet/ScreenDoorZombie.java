...
public class ScreenDoorZombie extends BucketHeadZombie{
	...
	private int item =110;
		...
		public ScreenDoorZombie(Coordinates coordonnee) {
			super(coordonnee);
		...
		public void Damage(InterfacePlant ip) {
			if (ip.inRange(this)==true) {
				if ((item>0)&&(!(ip instanceof FumeShroom))) {
		...
		public String toString() {
			return "ScreenDoorZombie [name=" + name + ", coordonnee=" + coordonnee + "]";
		}
