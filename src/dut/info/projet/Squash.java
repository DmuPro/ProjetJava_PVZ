...
public class Squash implements InterfacePlant {
	private final String name = "Squash";
	private int pv;
	...
	public Squash(Coordinates coordonnee) {
	...
	public String toString() {
		return "Squash [name=" + name + ", coordonnee=" + coordonnee + "]";
	}
	public void oneShot() {
		pv=0;
	}
